...
void RenderThread::run()
{
	...
	emit PrintString("Init modle file...");
	{
		Feimos::ModelLoad ML;
		...
		Feimos::Transform tri_Object2WorldModel = Feimos::Translate(Feimos::Vector3f(0.0, -2.7, 1.0)) * Feimos::Scale(0.003, 0.003, 0.003);
		ML.loadModel("../../Resources/girl/091_W_Aya_100K.obj", tri_Object2WorldModel);
