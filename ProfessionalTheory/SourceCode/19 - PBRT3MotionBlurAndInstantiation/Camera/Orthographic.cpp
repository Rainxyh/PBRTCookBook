...
namespace Feimos
{
	...
	OrthographicCamera *CreateOrthographicCamera(const int RasterWidth, const int RasterHeight, const AnimatedTransform &cam2world, float shutterOpen, float shutterClose, Medium *media)
	{
		...
		return new OrthographicCamera(RasterWidth, RasterHeight, cam2world, screen, shutterOpen, shutterClose,
